...
//$mailto  = 'ga.aubertot@gmail.com'; 
// david.annebicque@univ-reims.fr  sandrine.piat@univ-reims.fr


//echo $mail;
// envoi l'email
mail($mail , '[Newsletter] Beever : Discover the four last projects !', $msg, $entete);

header('Location: http://195.83.128.55/~mmid114a12/beever/controler/c_index.php');
?>
