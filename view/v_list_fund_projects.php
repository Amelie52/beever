 ...
 <body>
 	...
 	<section class="txtcenter ban_white">
 		<div class="container">
 			<h2>Explore the funded projects</h2>
 			<p>On this page you will find all the Beever projects that has been successfully financed thanks to the Beevers’ donations.</p>
 		</div>
 	</section>
				...
				<div class="list_projects_total grid-3-1 grid-small-1">
					<div>
						<div class="grid-3 grid-small-1">
							<?php foreach ($fundProjects as $key => $une): ?> 
							<div>
					...
					<div class=" sidebar">
						...
						<div class="filter">
							...
							<br>
							<form action="../controler/c_list_fund_projects.php" method="POST">
