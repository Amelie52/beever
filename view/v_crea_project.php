...
<body>
	...
	<section class="nav_crea_project">
		<div class="grid-4 grid-small-1 txtcenter">
			<div class="active"><p>Launch a new project</p></div>
	...
	<section class="form_crea_project">
		...
		<form method="POST" action="../model/m_valid_project.php" enctype="multipart/form-data">
				<p class="txtcenter"><span>Please complete the form</span></p><br><br>
				<div class="grid-2 grid-small-1 txtcenter">
					<div>
						<input type="text" name="proj_name" placeholder="Name of your project" required><br>
						<select name="proj_catego">
					...
					<div>
						<textarea name="proj_present" maxlength="250" placeholder="Short presentation (250 characters limit)*" required></textarea>
					</div>
					<div>
						<select name="proj_country" required> 
					...
					<div>
						<input type="text" name="proj_city" placeholder="City*" required>
					</div>
					<div>
						<input type="number" name="proj_funds_obj" placeholder="Funds objective*" required>
					</div>
					<div>
						<select name="proj_duration" required>
							<option value="" disabled selected hidden>Duration of your project* (days)</option>
					...
					<div>
						<input type="hidden" name="MAX_FILE_SIZE" value="1000000">
     					...
     					<p class="txtleft file_button">Photo project <label for="pictures"><i class="fa fa-file-image-o" aria-hidden="true"></i>  Select a file</label></p>
					</div> 
					<div class="txtright">
