...
<ul class="nav menu">
      ...
      <li class="active"><a href="c_comments.php"><svg class="glyph stroked empty-message"><use xlink:href="#stroked-empty-message"></use></svg> Comments</a></li>
...
<!--      <li><a href="forms.html"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg></a></li>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">     
    ...
    <?php 
                   ...
                   echo " <tr> 
                            <td>" .$Comments['user_id_'] ."</td> 
                            <td> <a target='_blank' href='../../controler/c_project.php?name=".$Comments['proj_name_'] ."'> " .$Comments['proj_name_'] ."</a></td>
                            <td>" .$Comments['com_mess'] ."</td>
                            <td>" .$Comments['com_date'] ."</td>
                            <td><a href='../model/m_delete_com.php?id=".$Comments['com_id'] ."'>Delete</a></td>
                          </tr>";
                   endforeach;
